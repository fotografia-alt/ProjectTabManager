<strong>Important: the latest version of Project Tab Manager<strong>Important: the latest version of Project Tab Manager is a quick fix for the problem not being able to run this app on Chrome 80 and later. The author knows that there are number of issues to fix, but please be patient until they are fixed. Feel free to contact [the author](mailto:agektmr@gmail.com) if you feel strongly about any issues.</strong>
...
----
 is a quick fix for the problem not being able to run this app on Chrome 80 and later. The author knows that there are number of issues to fix, but please be patient until they are fixed. Feel free to contact [the author](mailto:agektmr@gmail.com) if you feel strongly about any issues.</strong>
